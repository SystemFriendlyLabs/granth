    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .card{position:relative;z-index:1;width:100%;max-width:400px;padding:40px 32px;background:#fff;border:2px solid #c0ccff;}
        ...
        .accent-line{height:3px;background:linear-gradient(to right,#2040cc,#00aaff,transparent);margin-bottom:28px;}
        ...
        .footer{text-align:center;margin-top:24px;font-family:'Share Tech Mono',monospace;font-size:8px;color:#c0cccc;letter-spacing:2px;}
      `}</style>
      <div className="root">
        <div className="grid"/>
        <div className="card">
