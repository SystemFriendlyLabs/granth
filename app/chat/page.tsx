    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .sb-head{padding:20px 18px 16px;border-bottom:2px solid #c0ccff;}
        ...
        .sb-close{display:none;position:absolute;top:16px;right:16px;background:none;border:none;font-size:20px;color:#9090c0;cursor:pointer;padding:4px;}
        ...
        @media(max-width:768px){.hamburger{display:flex;flex-direction:column;gap:4px;}}
        .hbar{width:20px;height:2px;background:#2040cc;transition:all 0.2s;}
        ...
        .ai-text pre{background:#f0f4ff;border:1px solid #c0ccff;border-left:3px solid #2040cc;padding:12px;margin:8px 0;overflow-x:auto;-webkit-overflow-scrolling:touch;}
